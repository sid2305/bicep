...
namespace Bicep.LanguageServer.Handlers
{
    public class ExternalSourceReference
    {
        ...
        public IOciArtifactReferenceParts ModuleParts { get; init; }
        ...
        public ExternalSourceReference(string title, IOciArtifactReferenceParts module, string? requestedFile)
        {
            ModuleParts = module;
        ...
        public ExternalSourceReference WithMainJson()
        {
            return this.WithRequestedSourceFile(null);
        }

        public ExternalSourceReference WithRequestedSourceFile(string? requestedSourceFile)
        {
            //asdfg change title
            return new ExternalSourceReference(Title, ModuleParts, requestedSourceFile);
        }
        ...
        public ExternalSourceReference(OciArtifactReference moduleReference, SourceArchive? sourceArchive)
        {
            ...
            ModuleParts = moduleReference.Parts;
