...
namespace Bicep.Core.Registry.Oci
{
    ...
    {
        public OciArtifactReference(ArtifactType type, IOciArtifactReferenceParts parts, Uri parentModuleUri) :
            ...
            base(OciArtifactReferenceFacts.Scheme, parentModuleUri)
        {
            ...
            Type = type;
            Parts = new OciArtifactReferenceParts(registry, repository, tag, digest);
        }

        public IOciArtifactReferenceParts Parts { get; }
        ...
        public static ResultWithDiagnostic<IOciArtifactReferenceParts> TryParseFullyQualifiedParts(string rawValue)
        {
            return TryParseParts(ArtifactType.Module, aliasName: null, rawValue, configuration: null);
        }

        // TODO: Completely remove aliasName and configuration dependencies and move the non-dependent portion to a static method on OciArtifactReferenceParts
        private static ResultWithDiagnostic<IOciArtifactReferenceParts> TryParseParts(ArtifactType type, string? aliasName, string unqualifiedReference, RootConfiguration? configuration)
        {
            ...
            switch (delimiter.Value)
            {
                case ':':
                    ...
                    return new(new OciArtifactReferenceParts(registry, repository, tag, digest: null));
                ...
                case '@':
                    ...
                    return new(new OciArtifactReferenceParts(registry, repository, tag: null, digest: digest));
