...
namespace Bicep.Core.Registry
{
    public abstract class ArtifactRegistry<T> : IArtifactRegistry where T : ArtifactReference
    {
        ...
        public abstract SourceArchive? TryGetSourceArchive(T reference);
        ...
        public SourceArchive? TryGetSources(ArtifactReference reference) => this.TryGetSourceArchive(ConvertReference(reference));
