...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepExternalSourceRequestHandlerTests
    {
        ...
        public ExternalSourceReference DecodeExternalSourceUri(Uri uri) //asdfg?
        {
        ...
        private static IEnumerable<object[]> GetExternalSourceLinkTestData()
        {
            ...
            static IEnumerable<ExternalSourceLinkTestData> GetData()
            {
                ...
                //asdfgyield return new ExternalSourceLinkTestData(registry: "hello.my\\registry.azurecr.io");
                //asdfgyield return new ExternalSourceLinkTestData(registry: "hello.my%20registry.azurecr.io");
