...
param parDeploySandbox bool = true

param parDeployDecomission bool = true
...
resource resSandboxMg 'Microsoft.Management/managementGroups@2023-04-01' = if (parDeploySandbox)  {
...
resource resDecommissionedMg 'Microsoft.Management/managementGroups@2023-04-01' = if (parDeployDecomission)  {
...
module modCustomerUsageAttribution '../commonDependencies/cuaIdTenant.bicep' = if (!parTelemetryOptOut) {
