...
module modNetworkingHubResourceGroup '../commonDependencies/resourceGroup.bicep' = {
...
module modNetworkWatcherResourceGroup '../commonDependencies/resourceGroup.bicep' = {
