...
@minValue(30)
@maxValue(730)
param parLogRetentionInDays int = 540
...
param parDeployDdosProtection bool = false
...
param parDeployLogAnalyticsWorkspace bool = false

var varManagementGroupId = '${parDeploymentPrefix}${parDeploymentSuffix}'

// Deploy management group resource groups
module modManagementResourceGroups 'platformDependencies/managementResourceGroups.bicep' = {
...
module modConnectivityResourceGroups 'platformDependencies/connectivityResourceGroups.bicep' = {
...
module modIdentityResourceGroups 'platformDependencies/identityResourceGroups.bicep' = {
...
module modManagedIdentity 'platformDependencies/deploy.bicep' = {
...
module modRoleAssignmentManagementGroup 'platformDependencies/roleAssignmentManagementGroup.bicep' = {
...
module modLogging 'platformDependencies/logging.bicep' = if (parDeployLogAnalyticsWorkspace) {
...
module modHubNetworking 'platformDependencies/hubNetworking.bicep' = if (parDeployHubNetwork) {
